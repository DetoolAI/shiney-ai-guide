        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-white border border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Facebook Ads</h3>
            ...
            <div className="p-6 rounded-2xl bg-white border border-gray-200">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Instagram Ads</h3>
              <p className="text-gray-500 text-sm">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-2xl font-bold text-gray-900">3-5x ROAS</p>
                  <p className="text-sm text-gray-500">Average return on ad spend</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-2xl font-bold text-gray-900">Qualified Leads Only</p>
                  <p className="text-sm text-gray-500">No more wasted conversations</p>
                </div>
              </div>
            </div>
          </div>
